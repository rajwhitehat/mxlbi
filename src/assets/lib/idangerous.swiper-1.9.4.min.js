...
var Swiper = function(f, b) {
  function g() {
      var c = y - l;
      b.loop && (c -= l);
      b.scrollContainer && (c = p - l,
      0 > c && (c = 0));
      b.slidesPerSlide > a.slides.length && (c = 0);
      return c
  }
  function j(c) {
      a.allowLinks || (c.preventDefault ? c.preventDefault() : c.returnValue = !1)
  }
  function r(c) {
    console.log('c', c)
    console.log(c.target.className ? c.target.className.indexOf("NoSwiping") : -1)
      if (a.isTouched || b.onlyExternal || b.preventClassNoSwiping && c.target && -1 < (c.target.className ? c.target.className.indexOf("NoSwiping") : -1))
          return !1;
      a.isTouched = !0;
      u = "touchstart" == c.type;
  ...
  function w(c) {
      if (a.isTouched && !b.onlyExternal && !(u && "mousemove" == c.type)) {
          ...
          "undefined" === typeof v && h && (v = !!(v || Math.abs(e - a.touches.startY) > Math.abs(d - a.touches.startX)));
          "undefined" === typeof v && !h && (v = !!(v || Math.abs(e - a.touches.startY) < Math.abs(d - a.touches.startX)));
          if (v)
              a.isTouched = !1;
          else if (c.assignedToSwiper)
              a.isTouched = !1;
          else if (c.assignedToSwiper = !0,
          b.preventLinks && (a.allowLinks = !1),
          b.autoPlay && a.stopAutoPlay(),
          !u || 1 == c.touches.length) {
              ...
              if (b.resistance) {
                  if (0 < a.positions.current && (!b.freeMode || b.freeModeFluid))
                      b.loop ? (c = 1,
                      0 < a.positions.current && (a.positions.current = 0)) : c = (2 * l - a.positions.current) / l / 2,
                      a.positions.current = 0.5 > c ? l / 2 : a.positions.current * c,
                      b.nopeek && (a.positions.current = 0);
                  if (a.positions.current < -g() && (!b.freeMode || b.freeModeFluid)) {
                      if (b.loop)
                          c = 1,
                          d = a.positions.current,
                          e = -g() - l;
                      else {
                          var f = (a.touches.current - a.touches.start) * b.ratio + (g() + a.positions.start);
                          c = (l + f) / l;
                          d = a.positions.current - f * (1 - c) / 2;
                          e = -g() - l / 2
                      }
                      b.nopeek && (d = a.positions.current - f,
                      e = -g());
                      a.positions.current = d < e || 0 >= c ? e : d
                  }
              }
              if (b.followFinger) {
                  b.moveStartThreshold ? Math.abs(a.touches.current - a.touches.start) > b.moveStartThreshold || D ? (D = !0,
                  h ? a.setTransform(a.positions.current, 0, 0) : a.setTransform(0, a.positions.current, 0)) : a.positions.current = a.positions.start : h ? a.setTransform(a.positions.current, 0, 0) : a.setTransform(0, a.positions.current, 0);
                  b.freeMode && a.updateActiveSlide(a.positions.current);
                  b.onSlideClick && a.clickedSlide && (a.clickedSlide = !1);
                  b.grabCursor && (a.container.style.cursor = "move",
  ...
  function s() {
      ...
      if (!b.onlyExternal && a.isTouched) {
          ...
          b.onSlideClick && a.clickedSlide && (b.onSlideClick(a),
          a.callPlugins("onSlideClick"));
          ...
          var c = a.positions.diff
            , d = a.positions.abs;
          5 > d && (300 > a.times.end - a.times.start && !1 == a.allowLinks) && (a.swipeReset(),
          b.preventLinks && (a.allowLinks = !0));
          var e = y - l;
          b.scrollContainer && (e = p - l);
          0 < a.positions.current ? a.swipeReset() : a.positions.current < -e ? a.swipeReset() : b.freeMode ? (300 > a.times.end - a.times.start && b.freeModeFluid && (d = a.positions.current + 2 * a.touches.diff,
          d < -1 * e && (d = -e),
          0 < d && (d = 0),
          h ? a.setTransform(d, 0, 0) : a.setTransform(0, d, 0),
          a.setTransition(2 * (a.times.end - a.times.start)),
          a.updateActiveSlide(d)),
          (!b.freeModeFluid || 300 <= a.times.end - a.times.start) && a.updateActiveSlide(a.positions.current)) : (x = 0 > c ? "toNext" : "toPrev",
          "toNext" == x && 300 >= a.times.end - a.times.start && (30 > d || !b.shortSwipes ? a.swipeReset() : a.swipeNext(!0)),
          "toPrev" == x && 300 >= a.times.end - a.times.start && (30 > d || !b.shortSwipes ? a.swipeReset() : a.swipePrev(!0)),
          e = p * b.slidesPerGroup,
          "toNext" == x && 300 < a.times.end - a.times.start && (d >= 0.5 * e ? a.swipeNext(!0) : a.swipeReset()),
          "toPrev" == x && 300 < a.times.end - a.times.start && (d >= 0.5 * e ? a.swipePrev(!0) : a.swipeReset()));
          if (b.onTouchEnd)
              b.onTouchEnd(a);
  ...
  function E() {
      ...
      if (b.onSlideChangeStart)
          if (b.queueStartCallbacks && !a._queueStartCallbacks)
              a._queueStartCallbacks = !0,
              b.onSlideChangeStart(a),
              a.transitionEnd(function() {
                  a._queueStartCallbacks = !1
              });
          else if (!b.queueStartCallbacks)
              b.onSlideChangeStart(a);
      b.onSlideChangeEnd && (b.queueEndCallbacks && !a.queueEndCallbacks ? a.support.transitions ? (a._queueEndCallbacks = !0,
      a.transitionEnd(b.onSlideChangeEnd)) : setTimeout(function() {
          b.onSlideChangeEnd(a)
      }, 10) : b.queueEndCallbacks || (a.support.transitions ? a.transitionEnd(b.onSlideChangeEnd) : setTimeout(function() {
          b.onSlideChangeEnd(a)
      }, 10)))
  }
  window.addEventListener || (window.Element || (Element = function() {}
  ),
  Element.prototype.addEventListener = HTMLDocument.prototype.addEventListener = addEventListener = function(a, b) {
  ...
  if (f.nodeType || document.querySelectorAll && 0 != document.querySelectorAll(f).length) {
      ...
      a.support = {
          ...
          transitions: a.isSupportTransitions()
      };
      ...
      a._extendSwiperSlide = function(b) {
          ...
          ;
          b.isActive = function() {
              return b.index() == a.activeIndex ? !0 : !1
          }
          ;
          ...
          ;
          b.data = function(a, e) {
              return e ? (b.setAttribute("data-" + a, e),
              b) : b.getAttribute("data-" + a)
          }
          ;
          return b
      }
      ...
      a._calcSlides = function() {
          ...
          c && (c != a.slides.length && a.createPagination) && (a.createPagination(),
      ...
      a.insertSlideAfter = function(b, d, e, f) {
          return !b ? !1 : d.nodeType ? a._extendSwiperSlide(d).insertAfter(b) : a.createSlide(d, e, f).insertAfter(b)
      }
      ;
      a.removeSlide = function(b) {
          return a.slides[b] ? (a.slides[b].remove(),
          !0) : !1
      }
      ;
      a.removeLastSlide = function() {
          return 0 < a.slides.length ? (a.slides[a.slides.length - 1].remove(),
          !0) : !1
      }
      ;
      ...
      a.init = function(c) {
          ...
          if (c || !(a.width == f && a.height == g)) {
              ...
              k = a.slides.length;
              b.scrollContainer ? (h || (n.style.width = "",
              n.style.height = "",
              a.slides[0].style.width = "",
              a.slides[0].style.height = ""),
              c = a.slides[0].offsetWidth,
              d = a.slides[0].offsetHeight,
              l = h ? a.width : a.height,
              p = h ? c : d,
              e = c,
              f = d) : (z ? (c = a.slides[0].offsetWidth,
              d = a.slides[0].offsetHeight) : (c = a.width / c,
              d = a.height / d),
              l = h ? a.width : a.height,
              p = h ? c : d,
              e = h ? k * c : a.width,
              f = h ? a.height : k * d,
              z && (b.slidesPerSlide = Math.round(l / p)));
              y = h ? e : f;
              for (g = 0; g < a.slides.length; g++) {
                  var j = a.slides[g];
                  z || (j.style.width = c + "px",
                  j.style.height = d + "px");
              ...
              n.style.width = e + "px";
              n.style.height = f + "px";
              0 < b.initialSlide && (b.initialSlide < k && !B) && (a.realIndex = a.activeIndex = b.initialSlide,
              b.loop && (a.activeIndex = a.realIndex - b.slidesPerSlide),
              a.activeSlide = a.activeIndex,
              h ? (a.positions.current = -b.initialSlide * c,
              a.setTransform(a.positions.current, 0, 0)) : (a.positions.current = -b.initialSlide * d,
              a.setTransform(0, a.positions.current, 0)));
      ...
      a.ie10 ? (n.addEventListener(a.touchEvents.touchStart, r, !1),
      document.addEventListener(a.touchEvents.touchMove, w, !1),
      document.addEventListener(a.touchEvents.touchEnd, s, !1)) : (a.support.touch && (n.addEventListener("touchstart", r, !1),
      n.addEventListener("touchmove", w, !1),
      n.addEventListener("touchend", s, !1)),
      b.simulateTouch && (n.addEventListener("mousedown", r, !1),
      ...
      a.destroy = function(c) {
          ...
          a.ie10 ? (n.removeEventListener(a.touchEvents.touchStart, r, !1),
          document.removeEventListener(a.touchEvents.touchMove, w, !1),
          document.removeEventListener(a.touchEvents.touchEnd, s, !1)) : (a.support.touch && (n.removeEventListener("touchstart", r, !1),
          n.removeEventListener("touchmove", w, !1),
      ...
      if (b.keyboardControl) {
          var G = function(b) {
              ...
              h ? ((37 == d || 39 == d) && b.preventDefault(),
              39 == d && a.swipeNext(),
              37 == d && a.swipePrev()) : ((38 == d || 40 == d) && b.preventDefault(),
              40 == d && a.swipeNext(),
              38 == d && a.swipePrev())
          };
      ...
      if (b.mousewheelControl) {
          ...
          var H = function(c) {
              ...
              b.freeMode ? (h ? a.getTranslate("x") : a.getTranslate("y"),
              h ? (d = a.getTranslate("x") + e,
              e = a.getTranslate("y"),
              0 < d && (d = 0),
              d < -g() && (d = -g())) : (d = a.getTranslate("x"),
              e = a.getTranslate("y") + e,
              0 < e && (e = 0),
              e < -g() && (e = -g())),
              a.setTransition(0),
              a.setTransform(d, e, 0)) : 0 > e ? a.swipeNext() : a.swipePrev();
              c.preventDefault ? c.preventDefault() : c.returnValue = !1;
              return !1
          };
      ...
      a.swipePrev = function(c) {
          ...
          c = Math.ceil(h ? a.getTranslate("x") : a.getTranslate("y"));
          var d = p * b.slidesPerGroup;
          c = (Math.ceil(-c / d) - 1) * d;
          0 > c && (c = 0);
      ...
      a.swipeTo = function(c, d, e) {
          ...
          if (!(c > k - 1) && (!(0 > c) || b.loop))
              ...
              c = -c * p,
              I && (b.loop && 0 < b.initialSlide && b.initialSlide < k) && (c -= b.initialSlide * p,
              I = !1),
              h ? a.setTransform(c, 0, 0) : a.setTransform(0, c, 0),
              a.setTransition(d),
              a.updateActiveSlide(c),
      ...
      a.updateActiveSlide = function(c) {
          a.previousIndex = a.previousSlide = a.realIndex;
          a.realIndex = Math.round(-c / p);
          b.loop ? (a.activeIndex = a.realIndex - b.slidesPerSlide,
          a.activeIndex >= k - 2 * b.slidesPerSlide && (a.activeIndex = k - 2 * b.slidesPerSlide - a.activeIndex),
          0 > a.activeIndex && (a.activeIndex = k - 2 * b.slidesPerSlide + a.activeIndex)) : a.activeIndex = a.realIndex;
      ...
      a.fixLoop = function() {
          ...
          a.realIndex > k - 2 * b.slidesPerSlide && (c = -k + a.realIndex + b.slidesPerSlide,
          a.swipeTo(c, 0, !1))
      }
      ;
...
Swiper.prototype = {
          ...
          for (var w = function() {
              ...
              if (!b)
                  for (var s = 0; s < r.length; s++)
                      j.removeEventListener(r[s], w, !1)
          }, s = 0; s < r.length; s++)
              j.addEventListener(r[s], w, !1)
  },
  ...
  getTranslate: function(f) {
      var b = this.wrapper, g, j, r = window.WebKitCSSMatrix ? new WebKitCSSMatrix(window.getComputedStyle(b, null).webkitTransform) : window.getComputedStyle(b, null).MozTransform || window.getComputedStyle(b, null).OTransform || window.getComputedStyle(b, null).MsTransform || window.getComputedStyle(b, null).msTransform || window.getComputedStyle(b, null).transform || window.getComputedStyle(b, null).getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,");
      g = r.toString().split(",");
      this.params.useCSS3Transforms ? ("x" == f && (j = 16 == g.length ? parseFloat(g[12]) : window.WebKitCSSMatrix ? r.m41 : parseFloat(g[4])),
      "y" == f && (j = 16 == g.length ? parseFloat(g[13]) : window.WebKitCSSMatrix ? r.m42 : parseFloat(g[5]))) : ("x" == f && (j = parseFloat(b.style.left, 10) || 0),
      "y" == f && (j = parseFloat(b.style.top, 10) || 0));
      return j
  },
  setTransform: function(f, b, g) {
      ...
      b = b || 0;
      g = g || 0;
      this.params.useCSS3Transforms ? this.support.threeD ? j.webkitTransform = j.MsTransform = j.msTransform = j.MozTransform = j.OTransform = j.transform = "translate3d(" + f + "px, " + b + "px, " + g + "px)" : (j.webkitTransform = j.MsTransform = j.msTransform = j.MozTransform = j.OTransform = j.transform = "translate(" + f + "px, " + b + "px)",
      this.ie8 && (j.left = f + "px",
      j.top = b + "px")) : (j.left = f + "px",
      j.top = b + "px");
